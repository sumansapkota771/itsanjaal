      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-lg sm:text-xl text-black-700 max-w-3xl mx-auto">
            Ready to start your next project? Contact us today and let's discuss how we can help transform your
            business.
          </p>
        </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <a href="tel:9863459299" className="text-gray-600 hover:text-red-600 transition-colors">
                        9863459299
                      </a>
                    </div>
                  </div>
